...
CREATE TABLE investments (
  ...
  -- >= 0: el cierre total de posición deja quantity = 0 (ver migración 20260702120000)
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- 7c. INVESTMENT SALES (ventas parciales/totales con ganancia realizada)
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
CREATE INDEX idx_investment_sales_user ON investment_sales(user_id, sold_at DESC);
CREATE INDEX idx_investment_sales_investment ON investment_sales(investment_id, sold_at DESC);
...
-- ============================================================
-- Venta atómica de posiciones (espejo de migración 20260702120000)
-- ============================================================
...
BEGIN
  ...
  INSERT INTO investment_sales (
    user_id, investment_id, quantity, price, currency, sold_at,
    purchase_price_at_sale, realized_pnl_native, realized_pnl_usd,
    ars_per_usd, notes
  ) VALUES (
    p_user_id, p_investment_id, p_quantity, p_price, p_currency,
    COALESCE(p_sold_at, CURRENT_DATE), v_inv.purchase_price,
    p_realized_pnl_native, p_realized_pnl_usd, p_ars_per_usd, p_notes
  )
