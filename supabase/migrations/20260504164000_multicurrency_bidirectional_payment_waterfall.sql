-- Tarjetas bimoneda:
-- - Pago en moneda secundaria (USD): cancela USD primero, remanente pasa a ARS.
-- - Pago en moneda primaria (ARS) con tipo de cambio explícito: cancela ARS primero,
--   remanente pasa a USD con la tasa inversa.
